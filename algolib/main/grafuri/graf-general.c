...
while (i < list_size(&graph_adjlists(graph))) {
   ...
   fprintf(stdout, "graf[%03d]=%s: ", i, (char *)((AdjList *)list_data(
      element))->vertex);
...
fprintf(stdout, "Stergere arc de la %s la %s\n", data1, data2);
...
fprintf(stdout, "Stergere varf %s\n", data1);
...
fprintf(stdout,"Adaugare arc invalid de la  %s la %s...Valoare=%d (-1=OK)\n",
   data1, data2, retval);
...
retval = graph_ins_edge(&graph, data1, data2);
fprintf(stdout,"Adaugare arc duplicat de la  %s la %s...Valoare=%d (1=OK)\n",
   data1, data2, retval);
...
fprintf(stdout, "Stergere arc invalid de la %s la %s...Valoare=%d (-1=OK)\n",
   data1, data2, retval);
...
fprintf(stdout, "Adaugare varf duplicat %s...Valoare=%d (1=OK)\n", data1,
   retval);
...
fprintf(stdout, "Adiacenta('graph_is_adjacent'): (%s, %s)...Valoare=%d (1=OK)\n",
   data1, data2, retval);
...
retval = graph_is_adjacent(&graph, data1, data2);
fprintf(stdout, "Adiacenta('graph_is_adjacent'): (%s, %s)...Valoare=%d (0=OK)\n",
   data1, data2, retval);
...
fprintf(stdout, "Varfuri adiacente la %s: ", data1);
